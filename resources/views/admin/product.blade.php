                    ...
                    <div class="card-header border-0">
                        <div class="row g-4">
                            <div class="col-sm-auto">
                                <div>
                                    <a href="{{ url('/admin/product/tambah') }}" class="btn btn-success" id="addproduct-btn"><i
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <ul class="nav nav-tabs-custom card-header-tabs border-bottom-0" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active fw-semibold" data-bs-toggle="tab" href="#productnav-published"
                                            role="tab">
                                            Published <span
...
@push('styles')
    ...
    <link rel="stylesheet" href="{{ asset('dashboard/assets/libs/nouislider/nouislider.min.css') }}">
...
@push('scripts')
    <!-- nouisliderribute js -->
    <script src="{{ asset('dashboard/assets/libs/nouislider/nouislider.min.js') }}"></script>
    ...
    <script src="{{ asset('unpkg.com/gridjs%406.2.0/plugins/selection/dist/selection.umd.js') }}"></script>
    <!-- ecommerce product list -->
    <script src="{{ asset('dashboard/assets/js/pages/ecommerce-product-list.init.js') }}"></script>
@endpush