                ...
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="{{ url('/admin/product/invoice') }}" class="btn btn-success btn-sm"><i
                            ...
                            <tbody>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="{{ url('/admin/product/slug/detail') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <x-img src="dashboard/assets/images/products/img-7.png" alt=""
                                                    class="img-fluid d-block" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="{{ url('/admin/product/slug/detail') }}"
                                ...
                                <tr>
                                    <td>
                                        <div class="d-flex">
                                            <div class="flex-shrink-0 avatar-md bg-light rounded p-1">
                                                <x-img src="dashboard/assets/images/products/img-3.png" alt=""
                                                    class="img-fluid d-block" />
                                            </div>
                                            <div class="flex-grow-1 ms-3">
                                                <h5 class="fs-15"><a href="{{ url('/admin/product/slug/detail') }}"
                ...
                <div class="card-header">
                    <div class="d-sm-flex align-items-center">
                        ...
                        <div class="flex-shrink-0 mt-2 mt-sm-0">
                            <a href="javascript:void(0);" class="btn btn-soft-info btn-sm mt-2 mt-sm-0 shadow-none"><i
                                    class="ri-map-pin-line align-middle me-1"></i> Change Address</a>
                            <a href="javascript:void(0);" class="btn btn-soft-danger btn-sm mt-2 mt-sm-0 shadow-none"><i
                                ...
                                <div class="accordion-header" id="headingTwo">
                                    <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-grow-1 ms-3">
                                                <h6 class="fs-15 mb-1 fw-semibold">Packed - <span class="fw-normal">Thu, 16
                                                        Dec 2021</span></h6>
                                            </div>
                                        </div>
                                    </a>
                ...
                <div class="card-body">
                    <ul class="list-unstyled mb-0 vstack gap-3">
                        <li>
                            <div class="d-flex align-items-center">
                                <div class="flex-shrink-0">
                                    <x-img src="dashboard/assets/images/users/avatar-3.jpg" alt="" class="avatar-sm rounded shadow" />
                                </div>
                                <div class="flex-grow-1 ms-3">
