                        ...
                        <div class="card-header border-bottom-dashed p-4">
                            <div class="d-flex">
                                <div class="flex-grow-1">
                                    <x-img src="dashboard/assets/images/logo-dark.png" class="card-logo card-logo-dark" alt="logo dark"
                                        height="17"/>
                                    <x-img src="dashboard/assets/images/logo-light.png" class="card-logo card-logo-light"
                            ...
                            <div class="mt-4">
                                <div class="alert alert-info">
                                    <p class="mb-0"><span class="fw-semibold">NOTES:</span>
                                        <span id="note">All accounts are to be paid within 7 days from receipt of invoice.
...
@endpush
@push('scripts')
    <script src="{{ asset('dashboard/assets/js/pages/invoicedetails.js') }}"></script>
@endpush