                                ...
                                <div class="swiper product-thumbnail-slider p-2 rounded bg-light">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <x-img src="dashboard/assets/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <x-img src="dashboard/assets/images/products/img-6.png" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <x-img src="dashboard/assets/images/products/img-1.png" alt="" class="img-fluid d-block" />
                                        </div>
                                        <div class="swiper-slide">
                                            <x-img src="dashboard/assets/images/products/img-8.png" alt="" class="img-fluid d-block" />
                                        </div>
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="nav-slide-item">
                                                <x-img src="dashboard/assets/images/products/img-8.png" alt=""
                                                    class="img-fluid d-block" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="nav-slide-item">
                                                <x-img src="dashboard/assets/images/products/img-6.png" alt=""
                                                    class="img-fluid d-block" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="nav-slide-item">
                                                <x-img src="dashboard/assets/images/products/img-1.png" alt=""
                                                    class="img-fluid d-block" />
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                            ...
                            <div class="mt-xl-0 mt-5">
                                <div class="d-flex">
                                    ...
                                    <div class="flex-shrink-0">
                                        <div>
                                            <a href="{{ url('/admin/product/tambah') }}" class="btn btn-light"
                                                            ...
                                                            <div class="border border-dashed rounded p-3">
                                                                ...
                                                                <div class="d-flex flex-grow-1 gap-2 mb-3">
                                                                    <a href="#" class="d-block">
                                                                        <x-img src="dashboard/assets/images/small/img-12.jpg" alt=""
                                                                            class="avatar-sm shadow rounded object-fit-cover" />
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <x-img src="dashboard/assets/images/small/img-11.jpg" alt=""
                                                                            class="avatar-sm shadow rounded object-fit-cover"/>
                                                                    </a>
                                                                    <a href="#" class="d-block">
                                                                        <x-img src="dashboard/assets/images/small/img-10.jpg" alt=""
                                                                            class="avatar-sm shadow rounded object-fit-cover"/>
                                                                    </a>
                                                                </div>
